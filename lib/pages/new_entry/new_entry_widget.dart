                                      ...
                                      return Wrap(
                                        ...
                                        children: List.generate(tags.length,
                                          ...
                                          return InkWell(
                                            ...
                                            onTap: () async {
                                              if (_model.tagSelection
                                                  .contains(tagsItem)) {
                                                setState(() {
                                                  _model.removeFromTagSelection(
                                                      tagsItem);
                                                });
                                              } else {
                                                setState(() {
                                                  _model.addToTagSelection(
                                                      tagsItem);
                                                });
                                              }
                                            },
                      ...
                      child: Row(
                        ...
                        children: [
                          Align(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                var entryRecordReference =
                                    EntryRecord.collection.doc();
                                await entryRecordReference.set({
                                  ...
                                  ...mapToFirestore(
                                    {
                                      'Tags': _model.tagSelection,
                                    },
                                  ),
                                });
                                _model.next = EntryRecord.getDocumentFromData({
                                  ...createEntryRecordData(
                                    title: _model.textController.text,
                                    ps5: _model.checkboxValue1,
                                    ps4: _model.checkboxValue2,
